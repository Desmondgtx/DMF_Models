...
if __name__ == "__main__":
    ...
    dt = 1E-3
    tmax = 600
    TR = 1      # esto determina cuanto espacio puede haber entre los eventos
    
    # Generar señal neural sintética
    t = np.linspace(0, tmax, int(tmax / dt))
    
    # Ejemplo 1: Oscilación modulada
    ...
    neural_signal[pulse_times] = 1          # en Hz, puede ser 1 o 0.1 o 0.01
    ...
    # Estimar HRF
    para = get_default_para(TR, 'fourier')
    results = rsHRF_estimate_HRF(BOLD_filt, para, n_jobs=1)
    ...
    BOLD = Sim(x_t[:,None], 1, dt) # Sim(re, nnodes, dt)
